...
where exists(select id_pasaje
				...
				and r.id_viaje = p.id_viaje and (pv.fecha_pago between fecha_actual and vencimiento))


--select p.id_cliente,p.id_cabina,p.id_viaje,p.id_crucero, pv.fecha_pago
--from [LEISTE_EL_CODIGO?].Pasaje p join [LEISTE_EL_CODIGO?].PagoDeViaje pv ON p.id_pago = pv.id_pago
--order by 1
--select * from [LEISTE_EL_CODIGO?].Reserva order by id_cliente
--........................................ PROCEDURES ......................................................
--........................................<ABM 1> ROL				......................................................
